      ...
      <main id="top">
        ...
        <section id="projects" className="container py-16 md:py-24">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3].map((i) => (
              <article
                key={i}
                className="hover-scale rounded-xl border border-border bg-card p-6 shadow-[var(--shadow-elegant)]"
              >
                <h3 className="font-medium mb-2">Project {i}</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  A brief description highlighting results and technologies
                  used.
                </p>
        ...
        <section id="contact" className="container pb-20">
          ...
          <p className="text-muted-foreground max-w-prose mb-6">
            Want a modern site with delightful 3D and motion? I’d love to hear
            about your project.
          </p>
          <a href="mailto:hello@example.com" className="story-link">
            hello@example.com
          </a>
        </section>
      </main>
